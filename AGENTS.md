...
This project is indexed by GitNexus as **uni-admin** (677 symbols, 1884 relationships, 57 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
